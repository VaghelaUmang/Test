...
@Component({
  selector: 'app-new-to-do-list-item',
  templateUrl: './new-to-do-list-item.page.html',
  styleUrls: ['./new-to-do-list-item.page.scss'],
})
export class NewToDoListItemPage implements OnInit {
  ...
  async saveData() {
      ...
      let data = {
          ...
          image: this.imgURL,
          showDates: this.data.showDates
      };

      this.global.newTodoListItem = data;
      ...
      this.http.post(url, data).subscribe((resp: any) => {
          ...
          this.alertController.create({
                  ...
                  localStorage.setItem("bLoadListitem", '1');
			            this.router.navigateByUrl('/another-to-do-list-item');
			          }
			        }
			      ]
			    }).then((alert) => {
 	...
 	async uploadImage() {
      ...
      const fileTransfer: FileTransferObject = this.transfer.create();
        ...
        this.global.displayAlert("Sorry we could not upload your photo, please try again later.");
	    });
