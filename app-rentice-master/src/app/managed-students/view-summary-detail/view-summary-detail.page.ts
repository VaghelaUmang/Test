...
@Component({
  selector: 'app-tutor-view-summary-detail',
  templateUrl: './view-summary-detail.page.html',
  styleUrls: ['./view-summary-detail.page.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class TutorViewSummaryDetailPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.activity = JSON.parse(localStorage.getItem('tutorsummaryActivity'));
  ...
  async doSearch() {
    ...
    let mainCatList = this.global.tutorMaincategoryList;
    let allSubCatList = this.global.tutorSubcategoryList;
