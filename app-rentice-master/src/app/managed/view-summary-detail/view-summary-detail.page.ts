...
@Component({
  selector: 'app-staff-view-summary-detail',
  templateUrl: './view-summary-detail.page.html',
  styleUrls: ['./view-summary-detail.page.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class StaffViewSummaryDetailPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.activity = JSON.parse(localStorage.getItem('staffsummaryActivity'));
  ...
  async doSearch() {
    ...
    let mainCatList = this.global.staffMaincategoryList;
    let allSubCatList = this.global.staffSubcategoryList;
