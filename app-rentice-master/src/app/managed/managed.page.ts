...
@Component({
  ...
  styleUrls: ['./managed.page.scss'],
})
export class ManagedPage implements OnInit {
  ...
  goStaffMenu(item) {
  	localStorage.setItem("currentStaff", JSON.stringify(item));
  	this.router.navigateByUrl('/staff-menu');
  }
}
