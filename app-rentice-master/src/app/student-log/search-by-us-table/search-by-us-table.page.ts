...
@Component({
  selector: 'app-search-by-us-table',
  templateUrl: './search-by-us-table.page.html',
  styleUrls: ['./search-by-us-table.page.scss'],
})
export class SearchByUSTablePage implements OnInit {
