...
@Component({
  ...
  templateUrl: './edit-portfolio.page.html',
  styleUrls: ['./edit-portfolio.page.scss'],
})
export class EditPortfolioPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.imgURL = '';
    this.currentPortfolio = JSON.parse(localStorage.getItem("currentPortfolioItem"));
    let hide = false;
    switch (this.global.portfolioFilter) {
      case "activity":
        hide = this.currentPortfolio.hide_activity;
        break;
      case "main category":
        hide = this.currentPortfolio.hide_main;
        break;
      case "sub category":
        hide = this.currentPortfolio.hide_sub;
        break;
      case "project":
        hide = this.currentPortfolio.hide_project;
        break;
      case "duration":
        hide = this.currentPortfolio.hide_duration;
        break;
      case "date":
        hide = this.currentPortfolio.hide_date;
        break;
      case "notes":
        hide = this.currentPortfolio.hide_notes;
        break;
      default:
        break;
    }
    this.data = {
        ...
        project: this.currentPortfolio.address,
        date1: this.currentPortfolio.created,
        date2: this.currentPortfolio.date2,
        notes: this.currentPortfolio.notes,
        photo: this.currentPortfolio.photo,
        activity: this.currentPortfolio.activity,
        activity2: this.currentPortfolio.activity2,
        activity3: this.currentPortfolio.activity3,
        created: this.currentPortfolio.created.substr(0, 10),
        photo2: this.currentPortfolio.photo2,
        photo3: this.currentPortfolio.photo3,
        purchased: this.currentPortfolio.purchased,
        duration: parseFloat(this.currentPortfolio.value),
        hide: hide,
        main: this.currentPortfolio.main,
        mainCat: this.currentPortfolio.mainCat,
        sub: this.currentPortfolio.sub,
        subCat: this.currentPortfolio.subCat
    };
  ...
  async doUploadImage(bReturn = false) {
    ...
    switch (this.global.portfolioFilter) {
      case "activity":
        ...
        break;
      case "main category":
        value = this.data.mainCat;
        break;
      case "sub category":
        value = this.data.subCat;
        break;
      case "project":
    ...
    const data = {
        list_id: this.data.list_id.toString(),
        value: value,
        filter: this.global.portfolioFilter,
        hide: this.data.hide ? 1 : 0
    };
    
    const url = "https://www.artisanideas.co.nz/api/app-rentice/update_portfolio_item.php";
    const loading = await this.loadingController.create({
      message: '',
    });
    await loading.present();
