...
@Component({
  selector: 'app-new-portfolio-list',
  templateUrl: './new-portfolio-list.page.html',
  styleUrls: ['./new-portfolio-list.page.scss'],
})
export class NewPortfolioListPage implements OnInit {
